...
reader_1.get_party_instance(role='guest', party_id=9999).algorithm_param(table=guest_train_data)
reader_1.get_party_instance(role='host', party_id=9999).algorithm_param(table=host_train_data[0])
...
pipeline.add_component(dataio_1, data=Data(data=reader_1.output.data), model=Model(dataio_1.output.model))
