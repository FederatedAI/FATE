...
from research.beaver_triples_generation.bt_carlo import BeaverTripleGenerationCarlo
from research.examples.beaver_triple_generation.operation_definition import get_mul_op_def_example

LOGGER = log_utils.getLogger()


class ArbiterBeaverTripleGenerationWorkflow(BeaverTripleGenerationWorkflow):

    def _initialize_beaver_triple_generator(self, config):
        LOGGER.debug("@ initialize arbiter beaver triple generator")
        self.ftl_transfer_variable = BeaverTripleTransferVariable()

        mul_op_def = get_mul_op_def_example()
        self.carlo = BeaverTripleGenerationCarlo(mul_op_def, self.ftl_transfer_variable)
...
if __name__ == '__main__':
    ...
    workflow = ArbiterBeaverTripleGenerationWorkflow()
    workflow.run()
