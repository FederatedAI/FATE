...
class BeaverTripleGenerationGuest(BaseBeaverTripleGeneration):
    ...
    def generate(self):
        ...
        LOGGER.info("@ initialize guest beaver triples")
        ...
        LOGGER.info("@ send guest beaver triple shares to host")
        ...
        LOGGER.info("@ get guest beaver triple shares from host")
        ...
        LOGGER.info("@ send guest beaver triple shares to carlo")
        ...
        LOGGER.info("@ get guest beaver triple shares from carlo")
        ...
        LOGGER.info("@ guest beaver triples generation finished!")
