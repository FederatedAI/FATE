...
class Cipherblock:
    ...
    def add_plaintext_f64_par(self, other: npt.NDArray[np.float64]) -> Cipherblock: ...
    def add_plaintext_f32_par(self, other: npt.NDArray[np.float32]) -> Cipherblock: ...
    def add_plaintext_i64_par(self, other: npt.NDArray[np.int64]) -> Cipherblock: ...
    def add_plaintext_i32_par(self, other: npt.NDArray[np.int32]) -> Cipherblock: ...
    def sub_cipherblock_par(self, other: Cipherblock) -> Cipherblock: ...
    def sub_plaintext_f64_par(self, other: npt.NDArray[np.float64]) -> Cipherblock: ...
    def sub_plaintext_f32_par(self, other: npt.NDArray[np.float32]) -> Cipherblock: ...
    def sub_plaintext_i64_par(self, other: npt.NDArray[np.int64]) -> Cipherblock: ...
    def sub_plaintext_i32_par(self, other: npt.NDArray[np.int32]) -> Cipherblock: ...
    def mul_plaintext_f64_par(self, other: npt.NDArray[np.float64]) -> Cipherblock: ...
    def mul_plaintext_f32_par(self, other: npt.NDArray[np.float32]) -> Cipherblock: ...
    def mul_plaintext_i64_par(self, other: npt.NDArray[np.int64]) -> Cipherblock: ...
    def mul_plaintext_i32_par(self, other: npt.NDArray[np.int32]) -> Cipherblock: ...
    def matmul_plaintext_ix2_f64_par(self, other: npt.NDArray[np.float64]) -> Cipherblock: ...
    def matmul_plaintext_ix2_f32_par(self, other: npt.NDArray[np.float32]) -> Cipherblock: ...
    def matmul_plaintext_ix2_i64_par(self, other: npt.NDArray[np.int64]) -> Cipherblock: ...
    def matmul_plaintext_ix2_i32_par(self, other: npt.NDArray[np.int32]) -> Cipherblock: ...
    def matmul_plaintext_ix1_f64_par(self, other: npt.NDArray[np.float64]) -> Cipherblock: ...
    def matmul_plaintext_ix1_f32_par(self, other: npt.NDArray[np.float32]) -> Cipherblock: ...
    def matmul_plaintext_ix1_i64_par(self, other: npt.NDArray[np.int64]) -> Cipherblock: ...
    def matmul_plaintext_ix1_i32_par(self, other: npt.NDArray[np.int32]) -> Cipherblock: ...
    def rmatmul_plaintext_ix2_f64_par(self, other: npt.NDArray[np.float64]) -> Cipherblock: ...
    def rmatmul_plaintext_ix2_f32_par(self, other: npt.NDArray[np.float32]) -> Cipherblock: ...
    def rmatmul_plaintext_ix2_i64_par(self, other: npt.NDArray[np.int64]) -> Cipherblock: ...
    def rmatmul_plaintext_ix2_i32_par(self, other: npt.NDArray[np.int32]) -> Cipherblock: ...
    def rmatmul_plaintext_ix1_f64_par(self, other: npt.NDArray[np.float64]) -> Cipherblock: ...
    def rmatmul_plaintext_ix1_f32_par(self, other: npt.NDArray[np.float32]) -> Cipherblock: ...
    def rmatmul_plaintext_ix1_i64_par(self, other: npt.NDArray[np.int64]) -> Cipherblock: ...
    def rmatmul_plaintext_ix1_i32_par(self, other: npt.NDArray[np.int32]) -> Cipherblock: ...
...
class PK:
    ...
    def encrypt_f64_par(self, a: npt.NDArray[np.float64]) -> Cipherblock: ...
    def encrypt_f32_par(self, a: npt.NDArray[np.float32]) -> Cipherblock: ...
    def encrypt_i64_par(self, a: npt.NDArray[np.int64]) -> Cipherblock: ...
    def encrypt_i32_par(self, a: npt.NDArray[np.int32]) -> Cipherblock: ...
...
class SK:
    ...
    def decrypt_f64_par(self, a: Cipherblock) -> npt.NDArray[np.float64]: ...
    def decrypt_f32_par(self, a: Cipherblock) -> npt.NDArray[np.float32]: ...
    def decrypt_i64_par(self, a: Cipherblock) -> npt.NDArray[np.int64]: ...
    def decrypt_i32_par(self, a: Cipherblock) -> npt.NDArray[np.int32]: ...
