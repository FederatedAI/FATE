...
The module receives train and, if provided, validate data as specified. Input data sets must be uploaded beforehand as with other federatedml models.
Local Baseline accepts both binary and multi-class data.
...
For examples of using Local Baseline module, please refer `here <../../../examples/pipeline/local_baseline>`__.
