...
| [DataIO](./federatedml/util.md)                                                  | DataIO                       | This component usually follows `Reader`. It transforms user-uploaded date into Instance object(deprecate in FATe-v1.7, use DataTransform instead). | data                                        | data                                      | model                  | model                   |
| [DataTransform](./federatedml/util.md)                                           | DataTransform                | This component usually follows `Reader`. It transforms user-uploaded date into Instance object.                                                    | data                                        | data                                      | model                  | model                   |
...
| [Federated Sampling](./federatedml/feature.md)                                   | FederatedSample              | Federated Sampling data so that its distribution become balance in each party.This module supports standalone and federated versions.              | data                                        | data                                      | model                  | model                   |
| [Feature Scale](./federatedml/feature.md)                                        | FeatureScale                 | Feature scaling and standardization.                                                                                                               | data                                        | data                                      | model                  | model                   |
| [Hetero Feature Binning](./federatedml/feature.md)                               | Hetero Feature Binning       | With binning input data, calculates each column's iv and woe and transform data according to the binned information.                               | data                                        | data                                      | model                  | model                   |
| [Homo Feature Binning](./federatedml/feature.md)                                 | Homo Feature Binning         | Calculate quantile binning through multiple parties                                                                                                | data                                        | data                                      | None                   | model                   |
| [OneHot Encoder](./federatedml/feature.md)                                       | OneHotEncoder                | Transfer a column into one-hot format.                                                                                                             | data                                        | data                                      | model                  | model                   |
| [Hetero Feature Selection](./federatedml/feature.md)                             | HeteroFeatureSelection       | Provide 5 types of filters. Each filters can select columns according to user config                                                               | data                                        | data                                      | model; isometric model | model                   |
| [Union](./federatedml/statistic/union.md)                                        | Union                        | Combine multiple data tables into one.                                                                                                             | List\[data\]                                | data                                      | model                  | model                   |
| [Hetero-LR](./federatedml/linear_model/logistic_regression.md)                   | HeteroLR                     | Build hetero logistic regression module through multiple parties.                                                                                  | train\_data; validate\_data; predict\_input | data                                      | model                  | model                   |
...
| [Hetero-LinR](./federatedml/linear_model/linear_regression.md)                   | HeteroLinR                   | Build hetero linear regression module through multiple parties.                                                                                    | train\_data; validate\_data; predict\_input | data                                      | model                  | model                   |
| [Hetero-Poisson](./federatedml/linear_model/poisson_regression.md)               | HeteroPoisson                | Build hetero poisson regression module through multiple parties.                                                                                   | train\_data; validate\_data; predict\_input | data                                      | model                  | model                   |
| [Homo-LR](./federatedml/linear_model/logistic_regression.md)                     | HomoLR                       | Build homo logistic regression module through multiple parties.                                                                                    | train\_data; validate\_data; predict\_input | data                                      | model                  | model                   |
| [Homo-NN](./federatedml/nn/homo_nn.md)                                           | HomoNN                       | Build homo neural network module through multiple parties.                                                                                         | train\_data; validate\_data; predict\_input | data                                      | model                  | model                   |
...
| [Hetero Secure Boost Feature Transformer](./federatedml/feature.md#sbt-feature-transformer) | SBT Feature Transformer      | This component can encode sample using Hetero SBT leaf indices.                                                                                    | data                                        | data                                      | model                  | model                   |
...
| [Homo OneHot Encoder](./federatedml/feature.md)                                  | HomoOneHotEncoder            | Build homo onehot encoder module through multiple parties.                                                                                         | data                                        | data                                      | model                  | model                   |
...
| [Column Expand](./federatedml/feature.md)                                        | Column Expand                | Add arbitrary number of columns with user-provided values.                                                                                         | data                                        | data                                      | model                  | model                   |
...
| [Sample Weight](./federatedml/util.md)                                           | Sample Weight                | This component assigns weight to instances according to user-specified parameters                                                                  | data                                        | data                                      | model                  | model                   |
| [Feature Imputation](./federatedml/feature.md)                                   | Feature Imputation           | This component imputes missing features using arbitrary methods/values                                                                             | data                                        | data                                      | model                  | model                   |
| [Label Transform](./federatedml/util.md)                                     | Label Transform              | This component replaces label with designated values                                                                                               | data                                        | data                                      | model                  | model                   |
