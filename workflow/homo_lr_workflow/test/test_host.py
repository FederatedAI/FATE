...
job_id = "1112233"
LOGGER_path = '/data/projects/fate/python/src/test_homo_host.log'
config_path = "/data/projects/fate/python/src/federatedml/workflow/homo_lr_workflow/test/host_runtime_conf.json"
runtime_json = """
{
...
class TestHomoLRHost(HostWorkFlow):
