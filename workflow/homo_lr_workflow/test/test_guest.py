...
from workflow import GuestWorkFlow

job_id = "112233"
LOGGER_path = '/data/projects/fate/python/src/test_homo_guest.log'
config_path = "/data/projects/fate/python/src/federatedml/workflow/homo_lr_workflow/test/guest_runtime_conf.json"
runtime_json = """
{
...
class TestHomoLRGuest(GuestWorkFlow):
