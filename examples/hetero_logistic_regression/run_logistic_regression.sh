...
load_file() {
    ...
    sed -ie "s/_scene_id/${scene_id}/g" ${conf_path}
...
train() {
    ...
    echo $predict_table
    sed -ie "s/_workflow_method/train/g" $cur_runtime_conf
    sed -ie "s/_train_table_name/$train_table/g" $cur_runtime_conf
    sed -ie "s/_predict_table_name/$predict_table/g" $cur_runtime_conf
    ...
    sed -ie "s/_scene_id/$scene_id/g" $cur_runtime_conf
...
cross_validation() {
    ...
    sed -ie "s/_workflow_method/cross_validation/g" $cur_runtime_conf
    sed -ie "s/_cross_validation_table_name/$cv_table/g" $cur_runtime_conf
    sed -ie "s/_work_mode/$work_mode/g" $cur_runtime_conf
    sed -ie "s/_guest_party_id/$guest_partyid/g" $cur_runtime_conf
    sed -ie "s/_host_party_id/$host_partyid/g" $cur_runtime_conf
    sed -ie "s/_arbiter_party_id/$arbiter_partyid/g" $cur_runtime_conf
