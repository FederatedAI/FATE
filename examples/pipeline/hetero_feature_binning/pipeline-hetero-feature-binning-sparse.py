...
def main(config="../../config.yaml", namespace=""):
    ...
    guest_train_data = {"name": "lx_guest", "namespace": f"experiment{namespace}"}
    host_train_data = {"name": "lx_host", "namespace": f"experiment{namespace}"}
    ...
    dataio_0.get_party_instance(role='host', party_id=host).\
        component_param(with_label=False, input_format="tag", tag_with_value=True,
