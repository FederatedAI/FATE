...
def main(data_base):
    ...
    guest_data = {"feats": "cora_feats_guest", "train" : "cora_train_guest", "val": "cora_val_guest", "test": "cora_test_guest", "adj": "cora_adj_guest", "namespace": f"experiment"}
    host_data = {"feats": "cora_feats_host", "train": "cora_train_host", "val": "cora_val_host", "test": "cora_test_host", "adj": "cora_adj_host", "namespace": f"experiment"}
