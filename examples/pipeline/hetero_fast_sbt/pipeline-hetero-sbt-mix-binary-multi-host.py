...
def main(config="../../config.yaml", namespace=""):
    ...
    dataio_0.get_party_instance(role="host", party_id=host_0).algorithm_param(with_label=False)
    dataio_0.get_party_instance(role="host", party_id=host_1).algorithm_param(with_label=False)
    dataio_1.get_party_instance(role="guest", party_id=guest).algorithm_param(with_label=True, output_format="dense")
    dataio_1.get_party_instance(role="host", party_id=host_0).algorithm_param(with_label=False)
    dataio_1.get_party_instance(role="host", party_id=host_1).algorithm_param(with_label=False)
