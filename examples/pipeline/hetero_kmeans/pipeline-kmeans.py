...
from pipeline.component.hetero_kmeans import HeteroKmeasn
...
def main(config="../../config.yaml", namespace=""):
    ...
    hetero_kmeans_0 = HeteroKmeasn(name='hetero_kmeans_0', **param)
    ...
    pipeline.add_component(evaluation_0, data=Data(train_data=hetero_kmeans_0.output.data))
