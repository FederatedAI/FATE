...
reader_0.hosts[0].component_param(path="eggroll:///${host_table_namespace}/${host_table_name}",
                                  format="raw_table")
...
reader_1.guest.component_param(path="eggroll:///${guest_table_namespace}/${guest_table_name}",
                               format="raw_table")

reader_1.hosts[0].component_param(path="eggroll:///${host_table_namespace}/${host_table_name}",
                                  format="raw_table")
