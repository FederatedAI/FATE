...
def main(config="../../config.yaml", namespace=""):
    ...
    # configure Reader for host
    reader_1.get_party_instance(role='host', party_id=hosts).component_param(table=host_validate_data)
    ...
    # configure DataIO for guest
    dataio_1_guest_party_instance.component_param(with_label=True)
    # get and configure DataIO party instance of host
    dataio_1.get_party_instance(role='host', party_id=hosts).component_param(with_label=False)
    ...
    pipeline.add_component(dataio_1, data=Data(data=reader_1.output.data),
                           model=Model(model=dataio_0.output.model))
