...
def main(config="../config.yaml", namespace=""):
    ...
    homo_lr_0.guest.task_setting(train_data=DataWarehouseChannel(name="vehicle_scale_homo_guest", namespace="experiment"))
    homo_lr_0.hosts[0].task_setting(train_data=DataWarehouseChannel(name="vehicle_scale_homo_host", namespace="experiment"))
