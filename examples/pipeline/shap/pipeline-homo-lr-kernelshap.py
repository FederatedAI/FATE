...
def main(config="../../config.yaml", namespace=""):
    ...
    # start component numbering at 0
    ...
    pipeline.add_component(shap_0, data=Data(data=data_transform_0.output.data), model=Model(isometric_model=homo_lr_0.output.model))
