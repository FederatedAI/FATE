...
def main(config="../config.yaml", namespace=""):
    ...
    psi_0 = PSI("psi_0")
    psi_0.guest.task_setting(input_data=DataWarehouseChannel(name="student_hetero_guest",
                                                                    namespace="experiment"))
    psi_0.hosts[0].task_setting(input_data=DataWarehouseChannel(name="student_hetero_host",
                                                                        namespace="experiment"))
