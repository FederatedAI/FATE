...
from fate_client.pipeline.components.fate import DataSplit, PSI, Sample, FeatureScale, Reader
...
def main(config="../config.yaml", namespace=""):
    ...
    pipeline.add_tasks([reader_0, reader_1, psi_0, psi_1, data_split_0, data_split_1, sample_0, sample_1, feature_scale_0])
    pipeline.compile()
