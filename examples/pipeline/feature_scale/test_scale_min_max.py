...
from fate_client.pipeline.components.fate import PSI, FeatureScale, Statistics, Reader
...
def main(config="../config.yaml", namespace=""):
    ...
    pipeline.add_tasks([reader_0, reader_1, psi_0, psi_1, feature_scale_0, feature_scale_1, statistics_0])
