...
def build_conf(nn_define):
    ...
    conf_dict = {
        ...
        "job_parameters": {"work_mode": 1, "backend": 0, "dsl_version": 2},
        "role_parameters": {
            "host": {
                "0": {
                    "reader_0": {
...
def build_predict_dsl():
    dsl_dict = {
        "components": {
            ...
            "dataio_0": {
                "input": {"data": {"data": ["reader_0.data"]}, "model": ["pipeline.dataio_0.model"]},
                "module": "DataIO",
                "output": {"data": ["data"]}
            },
            "homo_nn_0": {
                "input": {"data": {"test_data": ["dataio_0.data"]}, "model": ["pipeline.homo_nn_0.model"]},
                "module": "HomoNN",
                "output": {"data": ["data"]}
            },
            "evaluation_0": {
