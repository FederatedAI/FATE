...
from fate_flow.utils.job_utils import get_job_configuration, get_job_directory, generate_job_id
...
def download_upload(access_module):
    ...
    job_id, job_dsl_path, job_runtime_conf_path, logs_directory, model_info, board_url = JobController.submit_job({'job_dsl': job_dsl, 'job_runtime_conf': job_runtime_conf}, job_id=job_id)
