...
import grpc
from fate_flow.settings import ROLE, IP, GRPC_PORT, LOCAL_URL, PROXY_HOST, PROXY_PORT, HEADERS, DEFAULT_GRPC_OVERALL_TIMEOUT, stat_logger
...
def get_url(_suffix):
    return "{}/{}".format(LOCAL_URL.rstrip('/'), _suffix.lstrip('/'))
