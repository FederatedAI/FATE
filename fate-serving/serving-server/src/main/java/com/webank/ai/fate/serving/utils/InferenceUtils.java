...
public class InferenceUtils {
    ...
    public static void logInference(Enum<FederatedInferenceType> inferenceType, FederatedParty federatedParty, FederatedRoles federatedRoles, String caseid, String seqno, int retcode, long elapsed, boolean getRemotePartyResult, boolean billing, Map<String, Object> inferenceRequest, ReturnResult inferenceResult) {
        inferenceAuditLogger.info("{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}", GetSystemInfo.localIp,inferenceType, federatedParty.getRole(), federatedParty.getPartyId(), FederatedUtils.federatedRolesIdentificationString(federatedRoles), caseid, seqno, retcode, elapsed, getRemotePartyResult ? 1 : 0, billing ? 1 : 0);
        ...
        inferenceLogger.info("{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}", GetSystemInfo.localIp,inferenceType, federatedParty.getRole(), federatedParty.getPartyId(), FederatedUtils.federatedRolesIdentificationString(federatedRoles), caseid, seqno, retcode, elapsed, getRemotePartyResult ? 1 : 0, billing ? 1 : 0, inferenceLogBase64String);
    }
