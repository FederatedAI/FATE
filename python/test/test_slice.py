...
def test_slice_local(t3, t4):
    assert torch.allclose(t3[[2, 3]].to_local().storage.data, t4[[2, 3]])


def test_slice_d(t1, t4):
    assert torch.allclose(t1[[2, 3]].to_local().storage.data, t4[[2, 3]])
