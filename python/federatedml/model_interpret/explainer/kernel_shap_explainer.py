...
class HomoKernelSHAP(KernelSHAP):
    ...
    def init_model(self, model: HeteroModelAdaptor):
        self.model = model
...
class HeteroKernelSHAP(KernelSHAP):
    ...
    def init_model(self, model: HeteroModelAdaptor, component_properties):
        self.model = model
        self.component_properties = component_properties
    ...
    def _sample_subsets(self, feat_num):
        ...
        LOGGER.debug('fully sampled subset num {}, max subset size {}'.format(fully_sampled_subset_num, max_subset_sizes))
