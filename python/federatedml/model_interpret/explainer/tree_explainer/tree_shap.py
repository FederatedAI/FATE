...
class HeteroTreeSHAP(TreeSHAP):
    ...
    def load_host_boosting_model(self):
        ...
        boosting_model = HeteroModelAdaptor(self.role, self.tree_model_meta, self.tree_model_param,
    ...
    def prepare_anonymous_fid_map(self, anonymous_list):
        ...
        for host_anonymous_feat in anonymous_list:
            ...
            flatten_anonymous_list += host_anonymous_feat
        # sort to keep order
        flatten_anonymous_list = sorted(flatten_anonymous_list)
    ...
    def explain(self, data_inst, n=500):
        ...
        # running guest code
            ...
            if self.full_explain:
                ...
                # LOGGER.debug('get info from host {} {}'.format(host_anonymous_list, host_node_anonymous))
            ...
            if not self.full_explain:
                ...
                LOGGER.debug('anonymous fid map is {}'.format(anonymous_fid_map))
            ...
            for sample_id, feat in zip(ids, arr):
                ...
                LOGGER.debug('contrib shape is {}'.format(contrib.shape))
    ...
    def explain_row(self, data_inst, tree_param, routes, host_fed_feat_idx=None, anonymous_fid_map=None,
        ...
        # LOGGER.debug('lgb feature name {}'.format(lgb_model.feature_name()))
        # shap_tree_explainer = TreeExplainer(lgb_model)
        # interaction_shap = shap_tree_explainer.shap_interaction_values(np.array(to_predict_sample))
