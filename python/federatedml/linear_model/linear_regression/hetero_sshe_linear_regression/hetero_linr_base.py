...
from federatedml.framework.hetero.procedure.hetero_sshe_linear_model import HeteroSSHEGuestBase, HeteroSSHEHostBase
from federatedml.linear_model.linear_model_weight import LinearModelWeights
from federatedml.param.hetero_sshe_linr_param import LinearParam
...
class HeteroLinRBase(BaseLinearModel, ABC):
    def __init__(self):
        super().__init__()
