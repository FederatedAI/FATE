...
_HETERONNMODELMETA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='config_type',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.config_type',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='bottom_nn_define',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.bottom_nn_define',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.interactive_layer_define',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='top_nn_define',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.top_nn_define',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='metrics',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.metrics',
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.optimizer_param',
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='loss',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.loss',
            index=6,
            number=7,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelMeta.interactive_layer_lr',
            index=7,
            number=8,
            type=1,
            cpp_type=5,
