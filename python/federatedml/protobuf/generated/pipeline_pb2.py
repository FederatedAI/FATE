...
_PIPELINE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='wokemode', full_name='com.webank.ai.fate.core.mlmodel.buffer.Pipeline.wokemode', index=9,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initiator_role_party_id', full_name='com.webank.ai.fate.core.mlmodel.buffer.Pipeline.initiator_role_party_id', index=11,
