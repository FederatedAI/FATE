...
_FEATUREBINNINGRESULT_BINNINGRESULTENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningResult.BinningResultEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningResult.BinningResultEntry.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_FEATUREBINNINGRESULT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='binning_result',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningResult.binning_result',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='role',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningResult.role',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='party_id',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningResult.party_id',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _FEATUREBINNINGRESULT_BINNINGRESULTENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
...
_BINNINGSINGLEFEATUREVALUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='values',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.BinningSingleFeatureValue.values',
            index=0,
            number=1,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name='col_names',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.BinningSingleFeatureValue.col_names',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value_name',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.BinningSingleFeatureValue.value_name',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
