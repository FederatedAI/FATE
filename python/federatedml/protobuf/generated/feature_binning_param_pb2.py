...
_FEATUREBINNINGPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='transform_binning_result', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.transform_binning_result', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='transform_host_results', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.transform_host_results', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='transform_multi_class_result', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.transform_multi_class_result', index=8,
...
_FEATUREBINNINGPARAM.fields_by_name['transform_binning_result'].message_type = _FEATUREBINNINGRESULT
_FEATUREBINNINGPARAM.fields_by_name['transform_host_results'].message_type = _FEATUREBINNINGRESULT
_FEATUREBINNINGPARAM.fields_by_name['transform_multi_class_result'].message_type = _MULTICLASSRESULT
...
MultiClassResult = _reflection.GeneratedProtocolMessageType('MultiClassResult', (_message.Message,), dict(
...
BinningSingleFeatureValue = _reflection.GeneratedProtocolMessageType('BinningSingleFeatureValue', (_message.Message,), dict(
