...
_INTERACTIVELAYERPARAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='acc_noise',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.InteractiveLayerParam.acc_noise',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='interactive_guest_saved_model_bytes',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.InteractiveLayerParam.interactive_guest_saved_model_bytes',
            index=1,
            number=2,
            type=12,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='interactive_host_saved_model_bytes',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.InteractiveLayerParam.interactive_host_saved_model_bytes',
            index=2,
            number=3,
            type=12,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='host_input_shape',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.InteractiveLayerParam.host_input_shape',
            index=3,
            number=4,
            type=5,
            cpp_type=1,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='guest_input_shape',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.InteractiveLayerParam.guest_input_shape',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
...
_HETERONNMODELPARAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelParam.bottom_saved_model_bytes',
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelParam.interactive_layer_param',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelParam.top_saved_model_bytes',
            index=2,
            number=3,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='is_empty',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelParam.is_empty',
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelParam.bottom_model_input_shape',
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name='com.webank.ai.fate.core.mlmodel.buffer.HeteroNNModelParam.top_model_input_shape',
            index=5,
            number=6,
            type=5,
            cpp_type=1,
