...
_SCALEPARAM_COLSCALEPARAMENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.ScaleParam.ColScaleParamEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.ScaleParam.ColScaleParamEntry.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SCALEPARAM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='col_scale_param',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.ScaleParam.col_scale_param',
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='header',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.ScaleParam.header',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
    ...
    extensions=[],
    nested_types=[
        _SCALEPARAM_COLSCALEPARAMENTRY,
    ],
    enum_types=[],
    serialized_options=None,
    is_extendable=False,
