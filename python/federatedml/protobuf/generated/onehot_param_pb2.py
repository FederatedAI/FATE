...
DESCRIPTOR = _descriptor.FileDescriptor(name='onehot-param.proto', package='com.webank.ai.fate.core.mlmodel.buffer', syntax='proto3', serialized_options=_b('B\020OneHotParamProto'), serialized_pb=_b(
...
_COLSMAP = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='values',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.ColsMap.values',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
            ...
            file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='transformed_headers',
            full_name='com.webank.ai.fate.core.mlmodel.buffer.ColsMap.transformed_headers',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
