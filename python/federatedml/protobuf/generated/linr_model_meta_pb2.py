...
_LINRMODELMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_sample_weight', full_name='com.webank.ai.fate.core.mlmodel.buffer.LinRModelMeta.use_sample_weight', index=9,
