...
_LRMODELPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_models', full_name='com.webank.ai.fate.core.mlmodel.buffer.LRModelParam.host_models', index=9,
...
_SINGLEMODEL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_models', full_name='com.webank.ai.fate.core.mlmodel.buffer.SingleModel.host_models', index=7,
...
_HOSTWEIGHTS = _descriptor.Descriptor(
  name='HostWeights',
  full_name='com.webank.ai.fate.core.mlmodel.buffer.HostWeights',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='host_weights', full_name='com.webank.ai.fate.core.mlmodel.buffer.HostWeights.host_weights', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='party_id', full_name='com.webank.ai.fate.core.mlmodel.buffer.HostWeights.party_id', index=1,
...
_LRMODELPARAM.fields_by_name['host_models'].message_type = _HOSTWEIGHTS
...
_SINGLEMODEL.fields_by_name['host_models'].message_type = _HOSTWEIGHTS
...
DESCRIPTOR.message_types_by_name['HostWeights'] = _HOSTWEIGHTS
...
HostWeights = _reflection.GeneratedProtocolMessageType('HostWeights', (_message.Message,), {
  'DESCRIPTOR' : _HOSTWEIGHTS,
  '__module__' : 'lr_model_param_pb2'
  # @@protoc_insertion_point(class_scope:com.webank.ai.fate.core.mlmodel.buffer.HostWeights)
  })
_sym_db.RegisterMessage(HostWeights)
