...
DESCRIPTOR = _descriptor.FileDescriptor(name='feature-scale-meta.proto', package='com.webank.ai.fate.core.mlmodel.buffer', syntax='proto3', serialized_options=_b('B\016ScaleMetaProto'), serialized_pb=_b(
