try:
    from federatedml.nn.backend.torch import nn as nn_
    from federatedml.nn.backend.torch import init as init_
    from federatedml.nn.backend.torch import optim as optim_
except ImportError:
    pass
