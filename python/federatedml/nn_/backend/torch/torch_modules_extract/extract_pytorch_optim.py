...
from federatedml.nn_.backend.torch.torch_modules_extract.extract_pytorch_modules import extract_init_param, Required
...
if __name__ == '__main__':
    ...
    module_str = """"""
    module_str += "from torch import optim\nfrom federatedml.nn_.backend.torch.base import FateTorchLayer, Sequential\n" \
