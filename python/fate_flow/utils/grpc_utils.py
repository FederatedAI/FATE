...
from fate_flow.settings import FATE_FLOW_SERVICE_NAME, ServiceSettings, HEADERS, JobDefaultSettings
...
def wrap_grpc_packet(json_body, http_method, url, src_party_id, dst_party_id, job_id=None, overall_timeout=None):
    ...
    _src_end_point = basic_meta_pb2.Endpoint(ip=ServiceSettings.HOST, port=ServiceSettings.GRPC_PORT)
