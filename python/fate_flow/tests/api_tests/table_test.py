...
server_url = "http://{}:{}/{}".format(ServiceSettings.HOST, ServiceSettings.HTTP_PORT, API_VERSION)
...
class TestTable(unittest.TestCase):
    def setUp(self):
        ...
        self.upload_config = {"file": os.path.join(self.data_dir, "breast_hetero_guest.csv"), "head": 1,
                              "partition": 10, "work_mode": ServiceSettings.WORK_MODE, "namespace": "fate_flow_test_table_breast_hetero",
