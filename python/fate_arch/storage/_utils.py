...
class StorageConnector():
    def __init__(self, connector_name, engine, connector_info=None):
    ...
    @property
    def info(self):
        connectors = StorageConnectorModel.select().where(operator.attrgetter("f_name")(StorageConnectorModel) == self.name,
                                                          operator.attrgetter("f_engine")(StorageConnectorModel) == self.engine)
        if connectors:
