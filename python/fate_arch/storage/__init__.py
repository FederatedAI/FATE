...
from fate_arch.storage._types import StandaloneStoreType, EggRollStoreType, HDFSStoreType, MySQLStoreType, FileStoreType, PathStoreType, HiveStoreType, LinkisHiveStoreType
