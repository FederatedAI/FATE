...
lr_0 = HeteroLR(name="lr_0", train_data=reader_0.outputs["output_data"], max_iter=1, batch_size=-1)
lr_1 = HeteroLR(name="lr_1", test_data=reader_0.outputs["output_data"], input_model=lr_0.outputs["output_model"])
