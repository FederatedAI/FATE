...
class StandaloneResourceManager(object):
    ...
    def _generate_output_metric_uri(self, job_id, role, party):
    ...
    @staticmethod
    def generate_log_uri(log_dir_prefix, job_id, task_name, role, party_id):
        return str(construct_local_dir(log_dir_prefix, *[job_id, task_name, role, str(party_id)]))
