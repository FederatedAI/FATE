...
from fate.ml.ensemble import HeteroSecureBoostGuest, HeteroSecureBoostHost, BINARY_CE, MULTI_CE, REGRESSION_L2
from fate.ml
...
def train(
    ...
    num_trees: cpn.parameter(type=params.conint(gt=0), default=20,
                          desc="max tree num"),
    ...
    objective: cpn.parameter.parameter(type=params.string_choice(choice=[BINARY_CE, MULTI_CE, REGRESSION_L2]), default=BINARY_CE, \
                                       desc='objective function, available: {}'.format([BINARY_CE, MULTI_CE, REGRESSION_L2])),
