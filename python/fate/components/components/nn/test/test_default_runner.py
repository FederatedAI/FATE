...
runner_conf=get_config_of_default_runner(
        ...
        dataset=DatasetLoader('table', 'TableDataset', flatten_label=True, label_dtype='long'),
        optimizer=optim.Adam(lr=0.01),
        training_args=TrainingArguments(num_train_epochs=50, per_device_train_batch_size=128),
