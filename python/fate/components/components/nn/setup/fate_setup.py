...
class FateSetup(NNRunner):
    ...
    def setup(self, stage='train'):
        ...
        if self.is_client():
            ...
            # prepare datatset
            cpn_input: ComponentInputData = self.get_cpn_input_data()

            # dataet
            train_set = self._prepare_dataset(self.dataset_conf, cpn_input.get_train_data())
            validate_set = self._prepare_dataset(self.dataset_conf, cpn_input.get_validate_data())
            test_set = self._prepare_dataset(self.dataset_conf, cpn_input.get_test_data())
