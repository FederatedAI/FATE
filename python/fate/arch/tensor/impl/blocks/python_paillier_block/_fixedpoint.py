...
class FixedPointNumber(object):
    ...
    def __mod__(self, other):
        return FixedPointNumber(
            self.encoding % other, self.exponent, n=self.n, max_int=self.max_int
        )
...
class FixedPointEndec(object):
    ...
    def _encode(self, scalar):
        return FixedPointNumber.encode(
            scalar, n=self.n, max_int=self.max_int, precision=self.precision
        )
