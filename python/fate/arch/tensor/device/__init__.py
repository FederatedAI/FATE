...
def _ops_dispatch_signature1_local_unknown_unknown(
    ...
    if _device == device.CPU:
        from .cpu import _ops_dispatch_signature_1_local_cpu_unknown
...
def _ops_dispatch_signature2_local_unknown_unknown(
    ...
    if _device == device.CPU:
        from .cpu import _ops_dispatch_signature_2_local_cpu_unknown
...
def _ops_dispatch_signature3_local_unknown_unknown(
    ...
    if _device == device.CPU:
        from .cpu import _ops_dispatch_signature_3_local_cpu_unknown
