...
df = pd.read_csv('/home/cwj/FATE/FATE-2.0-pure/FATE/examples/data/breast_homo_guest.csv')
...
client = HomoLRClient(50, 800, optimizer_param={'method': 'adam', 'penalty': 'l1', 'aplha':0.1, 'optimizer_para': {'lr': 0.1}}, init_param={'method': 'random', 'fill_val': 1.0},
