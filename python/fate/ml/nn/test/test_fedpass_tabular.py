...
from fate.ml.nn.hetero.hetero_nn import HeteroNNTrainerGuest, HeteroNNTrainerHost, TrainingArguments, StdAggLayerArgument, FedPassArgument
import sys
...
if __name__ == "__main__":
    ...
    if party == "guest":
        ...
        trainer = HeteroNNTrainerGuest(
            ...
            loss_fn=loss_fn,
            training_args=args,
            agg_layer_arguments=StdAggLayerArgument(
                merge_type='concat'
            ),
