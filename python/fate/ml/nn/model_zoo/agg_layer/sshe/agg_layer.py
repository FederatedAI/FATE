...
class SSHEAggLayerGuest(_AggLayerBase):
    ...
    def __init__(self, guest_in_features = 4, host_in_features = 4, out_features = 4, layer_lr = 0.01,
                 precision_bits=None, **kwargs):
        super().__init__()
        self._model = None
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict,
        ...
        super(SSHEAggLayerGuest, self)._load_from_state_dict(state_dict, prefix, local_metadata, strict,
                                                         missing_keys, unexpected_keys, error_msgs)
        self._set_wa_wb()
