...
if __name__ == '__main__':
    ...
    if party == 'guest':
        ...
        df = pd.read_csv(
            './../../../../../../../examples/data/vehicle_scale_hetero_guest.csv')
        ...
        trees = HeteroSecureBoostGuest(num_tree, max_depth=max_depth, l2=0.5, min_impurity_split=200, num_class=4, objective='multi:ce')
        ...
        df_host = pd.read_csv(
            './../../../../../../../examples/data/vehicle_scale_hetero_host.csv')
