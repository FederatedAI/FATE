...
if __name__ == '__main__':
    ...
    if party == 'guest':
        ...
        guest_inst = HeteroSecureBoostGuest(num_tree, max_depth=max_depth)
        guest_inst.fit(ctx, data_guest)
        ...
        host_inst = HeteroSecureBoostHost(num_tree, max_depth=max_depth)
        host_inst.fit(ctx, data_host)
