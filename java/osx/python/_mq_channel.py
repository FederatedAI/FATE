...
from fate_arch.protobuf.python import pcp_pb2
from fate_arch.protobuf.python import osx_pb2
from fate_arch.protobuf.python.pcp_pb2_grpc import PrivateTransferProtocolStub
...
class MQChannel(object):
    ...
    def consume(self, offset=-1):
        ...
        meta = dict(MessageTopic=self._send_topic,
                 TechProviderCode="FT",
    ...
    def query(self):
        ...
        meta = dict(MessageTopic=self._receive_topic,
                 TechProviderCode="FT",
                 SourceNodeID=self._src_party_id,
                 TargetNodeID=self._dst_party_id,
                 TargetComponentName=self._dst_role,
