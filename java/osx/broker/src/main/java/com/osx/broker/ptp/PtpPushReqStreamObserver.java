...
//
//public class PtpPushReqStreamObserver implements StreamObserver<Osx.Inbound> {
//
...
//    StreamObserver<Osx.Inbound> ptpForwardPushReqSO;
...
//    private StreamObserver<Osx.Outbound> backRespSO;
//
...
//                        Osx.Outbound outbound = Osx.Outbound.newBuilder().setCode(StatusCode.SUCCESS).setMessage(Dict.SUCCESS).setPayload(metadata.toByteString()).build();
...
//                Osx.Outbound outbound = outboundBuilder.build();
//                backRespSO.onNext(outbound);
//            }
//
//            @Override
