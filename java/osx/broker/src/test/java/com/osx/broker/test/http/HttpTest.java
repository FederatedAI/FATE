...
//    //int port = 8250;//nginx
//    int port = 9889;//nginx
    String url="http://localhost:8080/osx/xx";
    ...
    public void init() {
        ...
        MetaInfo.HTTP_CLIENT_CONFIG_CONN_REQ_TIME_OUT = Integer.valueOf("500");
        MetaInfo.HTTP_CLIENT_CONFIG_CONN_TIME_OUT = Integer.valueOf("2000");
        MetaInfo.HTTP_CLIENT_CONFIG_SOCK_TIME_OUT = Integer.valueOf(3000);
        MetaInfo.HTTP_CLIENT_INIT_POOL_MAX_TOTAL = Integer.valueOf(500);
        MetaInfo.HTTP_CLIENT_INIT_POOL_DEF_MAX_PER_ROUTE = Integer.valueOf(200);
        MetaInfo.HTTP_CLIENT_INIT_POOL_SOCK_TIME_OUT = Integer.valueOf(10000);
        MetaInfo.HTTP_CLIENT_INIT_POOL_CONN_TIME_OUT = Integer.valueOf(10000);
        MetaInfo.HTTP_CLIENT_INIT_POOL_CONN_REQ_TIME_OUT = Integer.valueOf(10000);
        MetaInfo.HTTP_CLIENT_TRAN_CONN_REQ_TIME_OUT = Integer.valueOf(60000);
        MetaInfo.HTTP_CLIENT_TRAN_CONN_TIME_OUT = Integer.valueOf(60000);
        MetaInfo.HTTP_CLIENT_TRAN_SOCK_TIME_OUT = Integer.valueOf(60000);
