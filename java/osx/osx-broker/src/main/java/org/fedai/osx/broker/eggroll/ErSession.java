...
public class ErSession {
    ...
    public ErSession(String sessionId, boolean createIfNotExists) {
        ...
        clusterManagerClient = new ClusterManagerClient(new CommandClient(new ErEndpoint(MetaInfo.PROPERTY_EGGROLL_CLUSTER_MANANGER_IP, MetaInfo.PROPERTY_EGGROLL_CLUSTER_MANANGER_PORT.intValue())));
