...
import org.fedai.osx.broker.queue.PutMessageResult;
        ...
        if (!MetaInfo.PROPERTY_SELF_PARTY.contains(context.getDesPartyId())) {
            ...
            while (tryTime < MetaInfo.PROPERTY_PRODUCE_MSG_MAX_TRY_TIME) {
                ...
                try {
                    ...
                    response = TransferUtil.redirect(context, produceRequest, routerInfo,usePooled);
                    if (response == null) {
                        continue;
                    }
                    break;
            ...
            if (transferQueue != null) {
                ...
                if (MetaInfo.PROPERTY_DEPLOY_MODE.equals(DeployMode.cluster.name())) {
                    ...
                    return TransferUtil.redirect(context, produceRequest, redirectRouterInfo,true);
                } else {
