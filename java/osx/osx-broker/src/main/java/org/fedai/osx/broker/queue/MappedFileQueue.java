...
import org.fedai.osx.broker.util.UtilAll;
    ...
    public MappedFile getLastMappedFile(final long startOffset, boolean needCreate) {
        ...
        if (createOffset != -1 && needCreate) {
            ...
            if (this.allocateMappedFileService != null) {
                mappedFile = this.allocateMappedFileService.putRequestAndReturnMappedFile(nextFilePath, this.mappedFileSize);
            } else {
                try {
...
//        MappedFileQueue   mappedFileQueue = new  MappedFileQueue("/tmp/kaideng",1024,allocateMappedFileService);
//
//        allocateMappedFileService.start();
//        MappedFile mappedFile = allocateMappedFileService.putRequestAndReturnMappedFile("/tmp/0",1024);
//
//        //final MessageExtBrokerInner msg, final AppendMessageCallback cb
//        MessageExtBrokerInner messageExtBrokerInner = new MessageExtBrokerInner();
//        messageExtBrokerInner.setBody("kaideng".getBytes());
//        messageExtBrokerInner.setTopic("kaidengTopic");
//        messageExtBrokerInner.setBornHost(new InetSocketAddress(1111) );
//        for(int i=0;i<10;i++) {
//            AppendMessageResult appendMessageResult = mappedFile.appendMessage(messageExtBrokerInner, new DefaultAppendMessageCallback(2048));
//            System.err.println(appendMessageResult);
//            try {
//                Thread.sleep(1000);
//            } catch (InterruptedException e) {
//                e.printStackTrace();
