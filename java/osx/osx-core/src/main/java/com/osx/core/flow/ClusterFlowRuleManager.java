...
public final class ClusterFlowRuleManager {
    ...
    private static void initDefaultProperty() {
        ...
        currentPath = PROPERTY_CONFIG_DIR + "/" + MetaInfo.PROPERTY_FLOW_RULE_TABLE;
...
//            }
            ...
            ClusterMetricStatistics.putMetricIfAbsent(rule.getResource(),
                    new ClusterMetric(PROPERTY_FLOW_CONTROL_SAMPLE_COUNT, PROPERTY_FLOW_CONTROL_SAMPLE_INTERVAL));
        }
