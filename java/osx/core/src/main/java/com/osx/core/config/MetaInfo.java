...
public class MetaInfo {
    ...
    public static int     PROPERTY_GRPC_CHANNEL_MAX_CONCURRENT_CALL_PER_CONNECTION = 1000;
    public static int     PROPERTY_GRPC_CHANNEL_MAX_INBOUND_METADATA_SIZE = 128<<20;
    public static int     PROPERTY_GRPC_CHANNEL_MAX_INBOUND_MESSAGE_SIZE  = (2 << 30) - 1;
    public static int     PROPERTY_GRPC_CHANNEL_FLOW_CONTROL_WINDOW =  128<<20;
    public static int     PROPERTY_GRPC_CHANNEL_KEEPALIVE_TIME_SEC = 7200;
    public static int     PROPERTY_GRPC_CHANNEL_KEEPALIVE_TIMEOUT_SEC = 3600;
    public static int     PROPERTY_GRPC_CHANNEL_PERMIT_KEEPALIVE_TIME_SEC = 10;
    public static boolean PROPERTY_GRPC_CHANNEL_KEEPALIVE_WITHOUT_CALLS_ENABLED = true;
    public static int     PROPERTY_GRPC_CHANNEL_MAX_CONNECTION_IDLE_SEC = 86400;
    public static int     PROPERTY_GRPC_CHANNEL_MAX_CONNECTION_AGE_SEC = 86400;
    public static int     PROPERTY_GRPC_CHANNEL_MAX_CONNECTION_AGE_GRACE_SEC = 86400;
    ...
    public static String PROPERTY_DLEDGER_PEER;
    public static String PROPERTY_DLEDGER_SELF;
