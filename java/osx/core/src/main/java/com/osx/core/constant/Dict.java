...
//    public static final String PROPERTY_SERVER_PORT = "server.port";
    ...
    public static final String PROPERTY_GRPC_CHANNEL_MAX_CONCURRENT_CALL_PER_CONNECTION = "grpc.channel.max.concurrent.call.per.connection";
    public static final String PROPERTY_GRPC_CHANNEL_MAX_INBOUND_MESSAGE_SIZE = "grpc.channel.max.inbound.message.size";
    public static final String PROPERTY_GRPC_CHANNEL_MAX_INBOUND_METADATA_SIZE = "grpc.channel.max.inbound.metadata.size";
    public static final String PROPERTY_GRPC_CHANNEL_FLOW_CONTROL_WINDOW = "grpc.channel.flow.control.window";
    public static final String PROPERTY_GRPC_CHANNEL_KEEPALIVE_TIME_SEC = "grpc.channel.keepalive.time.sec";
    public static final String PROPERTY_GRPC_CHANNEL_KEEPALIVE_TIMEOUT_SEC = "grpc.channel.keepalive.timeout.sec";
    public static final String PROPERTY_GRPC_CHANNEL_PERMIT_KEEPALIVE_TIME_SEC = "grpc.channel.permit.keepalive.time.sec";
    public static final String PROPERTY_GRPC_CHANNEL_KEEPALIVE_WITHOUT_CALLS_ENABLED = "grpc.channel.keepalive.without.calls.enabled";
    public static final String PROPERTY_GRPC_CHANNEL_MAX_CONNECTION_IDLE_SEC = "grpc.channel.max.connection.idle.sec";
    public static final String PROPERTY_GRPC_CHANNEL_MAX_CONNECTION_AGE_SEC = "grpc.channel.max.connection.age.sec";
    public static final String PROPERTY_GRPC_CHANNEL_MAX_CONNECTION_AGE_GRACE_SEC = "grpc.channel.max.connection.age.grace.sec";
