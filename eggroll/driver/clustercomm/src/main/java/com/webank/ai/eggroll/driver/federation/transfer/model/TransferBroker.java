...
package com.webank.ai.eggroll.driver.federation.transfer.model;
...
public class TransferBroker {
    ...
    public TransferBroker(ClusterComm.TransferMeta transferMeta) {
        this(transferMeta, DEFAULT_QUEUE_CAPACITY);
    }

    public TransferBroker(ClusterComm.TransferMeta transferMeta, int queueCapacity) {
    ...
    public TransferBroker(String transferMetaId) {
        this((ClusterComm.TransferMeta) null, DEFAULT_QUEUE_CAPACITY);
    }

    public TransferBroker(String transferMetaId, int queueCapacity) {
        this((ClusterComm.TransferMeta) null, queueCapacity);
    }
     ...
     */
    public ClusterComm.TransferMeta getTransferMeta() {
    ...
    public TransferBroker setTransferMeta(ClusterComm.TransferMeta transferMeta) {
