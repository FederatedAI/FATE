...
package com.webank.ai.eggroll.driver.clustercomm.transfer.api.grpc.observer;
...
@Component
@Scope("prototype")
public class SendClientResponseObserver extends CallerWithSameTypeDelayedResultResponseStreamObserver<ClusterComm.TransferMeta, ClusterComm.TransferMeta> {
    private static final Logger LOGGER = LogManager.getLogger();
    @Autowired
    private ToStringUtils toStringUtils;

    public SendClientResponseObserver(CountDownLatch finishLatch, DelayedResult<ClusterComm.TransferMeta> delayedResult) {
        super(finishLatch, delayedResult);
    }

    @Override
    public void onNext(ClusterComm.TransferMeta transferMeta) {
