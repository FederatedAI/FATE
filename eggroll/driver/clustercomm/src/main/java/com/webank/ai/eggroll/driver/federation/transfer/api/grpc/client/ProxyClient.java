...
package com.webank.ai.eggroll.driver.federation.transfer.api.grpc.client;
...
import com.webank.ai.eggroll.driver.federation.factory.TransferServiceFactory;
import com.webank.ai.eggroll.driver.federation.transfer.utils.TransferProtoMessageUtils;
import com.webank.ai.eggroll.driver.federation.transfer.api.grpc.observer.PushClientResponseStreamObserver;
import com.webank.ai.eggroll.driver.federation.transfer.api.grpc.observer.UnaryCallServerRequestStreamObserver;
import com.webank.ai.eggroll.driver.federation.transfer.api.grpc.processor.PushStreamProcessor;
...
public class ProxyClient {
    ...
    public ClusterComm.TransferMeta requestSendStart(ClusterComm.TransferMeta transferMeta, BasicMeta.Endpoint endpoint) {
        ...
        ClusterComm.TransferMeta result = transferProtoMessageUtils.extractTransferMetaFromPacket(response);

        return result;
    }

    public ClusterComm.TransferMeta requestSendEnd(ClusterComm.TransferMeta transferMeta, BasicMeta.Endpoint endpoint) {
