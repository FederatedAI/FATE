...
public class TransferPojoUtils {
    ...
    public String generateTransferId(ClusterComm.TransferMeta transferMeta) {
        ...
        ClusterComm.Party src = transferMeta.getSrc();
        ClusterComm.Party dst = transferMeta.getDst();
...
/*    public String generateTransferId(BasicMeta.Job job, String tag) {
    ...
    public String generateSendObjectKey(ClusterComm.TransferMeta transferMeta) {
        Preconditions.checkNotNull(transferMeta, "transferMeta cannot be null");
