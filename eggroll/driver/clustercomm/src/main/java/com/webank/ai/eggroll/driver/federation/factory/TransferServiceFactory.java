...
package com.webank.ai.eggroll.driver.federation.factory;
...
import com.webank.ai.eggroll.driver.federation.transfer.communication.action.DtableRecvConsumeAction;
import com.webank.ai.eggroll.driver.federation.transfer.communication.action.ObjectRecvConsumeLmdbAction;
import com.webank.ai.eggroll.driver.federation.transfer.communication.action.SendConsumeAction;
import com.webank.ai.eggroll.driver.federation.transfer.communication.action.TransferQueueConsumeAction;
import com.webank.ai.eggroll.driver.federation.transfer.communication.consumer.TransferBrokerConsumer;
import com.webank.ai.eggroll.driver.federation.transfer.communication.processor.RecvProcessor;
import com.webank.ai.eggroll.driver.federation.transfer.communication.processor.SendProcessor;
import com.webank.ai.eggroll.driver.federation.transfer.communication.producer.DtableFragmentSendProducer;
import com.webank.ai.eggroll.driver.federation.transfer.communication.producer.ObjectLmdbSendProducer;
import com.webank.ai.eggroll.driver.federation.transfer.api.grpc.observer.PushServerRequestStreamObserver;
import com.webank.ai.eggroll.driver.federation.transfer.model.TransferBroker;
...
public class TransferServiceFactory {
    ...
    @Autowired
    private GrpcStreamingClientTemplate<TransferSubmitServiceGrpc.TransferSubmitServiceStub, ClusterComm.TransferMeta, ClusterComm.TransferMeta> nonSpringSubmitTemplate;
    @Autowired
    private GrpcAsyncClientContext<TransferSubmitServiceGrpc.TransferSubmitServiceStub, ClusterComm.TransferMeta, ClusterComm.TransferMeta> nonSpringSubmitContext;

    public TransferServiceFactory() {
    }

    public SendProcessor createSendProcessor(ClusterComm.TransferMeta transferMeta) {
        return applicationContext.getBean(SendProcessor.class, transferMeta);
    }

    public RecvProcessor createRecvProcessor(ClusterComm.TransferMeta transferMeta) {
    ...
    public TransferBroker createTransferBroker(ClusterComm.TransferMeta transferMeta) {
        return applicationContext.getBean(TransferBroker.class, transferMeta);
    }

    public TransferBroker createTransferBroker(ClusterComm.TransferMeta transferMeta, int capacity) {
...
/*    public PushStreamProcessor createPushStreamProcessor(TransferBroker transferBroker) {
    ...
    public GrpcAsyncClientContext<TransferSubmitServiceGrpc.TransferSubmitServiceStub, ClusterComm.TransferMeta, ClusterComm.TransferMeta>
    ...
    public GrpcStreamingClientTemplate<TransferSubmitServiceGrpc.TransferSubmitServiceStub, ClusterComm.TransferMeta, ClusterComm.TransferMeta>
