...
package com.webank.ai.fate.eggroll.meta.service.api.grpc.server;
...
import com.webank.ai.fate.core.helper.ParamValidationHelper;
...
import com.webank.ai.fate.core.utils.CrudUtils;
import com.webank.ai.fate.core.utils.ToStringUtils;
import com.webank.ai.fate.eggroll.meta.service.dao.generated.model.*;
import com.webank.ai.fate.eggroll.meta.service.factory.DaoServiceFactory;
import com.webank.ai.fate.eggroll.meta.service.factory.GrpcCrudServiceFactory;
import com.webank.ai.fate.eggroll.meta.service.service.CrudServerProcessor;
import com.webank.ai.fate.eggroll.meta.service.service.GrpcCrudService;
...
public class StorageMetaServiceImpl extends StorageMetaServiceGrpc.StorageMetaServiceImplBase {
    ...
    @PostConstruct
    public void init() {
        dtableGrpcCrudService = grpcCrudServiceFactory.createGrpcCrudService(Dtable.class);
    ...
    public void createTableIfAbsent(BasicMeta.CallRequest request, StreamObserver<BasicMeta.CallResponse> responseObserver) {
        ...
        dtableGrpcCrudService.processCrudRequest(request, responseObserver, new CrudServerProcessor<Dtable>() {
            @Override
            public Dtable process(Object record) throws CrudException {
                ...
                if (!selectResult.isEmpty()) {
                    ...
                    try {
                        ...
                        selectResult = (List<Dtable>) callResult;
            ...
            @Override
            public boolean isValid(Dtable result) {
                return true;
            }
    ...
    public void getFragmentsByTableId(BasicMeta.CallRequest request, StreamObserver<BasicMeta.CallResponse> responseObserver) {
        ...
        dtableGrpcCrudService.processCrudRequest(request, responseObserver, new CrudServerProcessor<List<Fragment>>() {
            @Override
            public List<Fragment> process(Object record) throws CrudException {
                ...
                List<Fragment> selectResult = (List<Fragment>) callResult;

                return selectResult;
            }

            @Override
            public boolean isValid(List<Fragment> result) {
                return result != null;
            }
    ...
    public void getStorageNodesByTableId(BasicMeta.CallRequest request, StreamObserver<BasicMeta.CallResponse> responseObserver) {
        ...
        nodeGrpcCrudService.processCrudRequest(request, responseObserver, new CrudServerProcessor<List<Node>>() {
            @Override
            public List<Node> process(Object record) throws CrudException {
                ...
                List<Fragment> fragments = fragmentDaoService.selectByExample(fragmentExample);
                ...
                List<Node> result = nodeDaoService.selectByExample(nodeExample);
    ...
    public void createFragmentsForTable(BasicMeta.CallRequest request, StreamObserver<BasicMeta.CallResponse> responseObserver) {
        ...
        fragmentGrpcCrudService.processCrudRequest(request, responseObserver, new CrudServerProcessor<List<Fragment>>() {
            @Override
            public List<Fragment> process(Object record) throws CrudException {
                GenericDaoService fragmentDaoService = fragmentGrpcCrudService.getGenericDaoService();
                GenericDaoService nodeDaoService = nodeGrpcCrudService.getGenericDaoService();
                ...
                List<Node> healthyStorageNodes = nodeDaoService.selectByExample(nodeExample);
                ...
                for (int i = 0; i < totalFragments; ++i) {
                    ...
                    Node node = healthyStorageNodes.get(i % healthyNodeSize);
    ...
    public class GetNodeOfStatusCrudProcessor implements CrudServerProcessor<List<Node>> {
        @Override
        public List<Node> process(Object record) throws CrudException {
            GenericDaoService genericDaoService = nodeGrpcCrudService.getGenericDaoService();
