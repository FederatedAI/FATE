...
@Component
@Scope("prototype")
public class RollKvDestroyResponseObserver extends BaseCallerResponseStreamObserver<Kv.Empty, Kv.Empty> {
    private static final Logger LOGGER = LogManager.getLogger();

    public RollKvDestroyResponseObserver(CountDownLatch finishLatch) {
        super(finishLatch);
    }

    @Override
    public void onNext(Kv.Empty empty) {
        LOGGER.info("RollKvDestroyResponseObserver.onNext");
    }
}
