...
@Component
@Scope("prototype")
public class RollKvPutResponseObserver extends BaseCallerResponseStreamObserver<Kv.Operand, Kv.Empty> {
    private static final Logger LOGGER = LogManager.getLogger();

    public RollKvPutResponseObserver(CountDownLatch finishLatch) {
        super(finishLatch);
    }

    @Override
    public void onNext(Kv.Empty empty) {
        LOGGER.info("RollKvPutResponseObserver.onNext");
    }
}
