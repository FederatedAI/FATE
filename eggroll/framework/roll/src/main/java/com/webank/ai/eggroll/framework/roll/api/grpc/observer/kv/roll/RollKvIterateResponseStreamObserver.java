...
@Component
@Scope("prototype")
public class RollKvIterateResponseStreamObserver extends BaseCallerResponseStreamObserver<Kv.Range, Kv.Operand> {
    private static final Logger LOGGER = LogManager.getLogger();
    @Autowired
    private ToStringUtils toStringUtils;
    private OperandBroker operandBroker;

    public RollKvIterateResponseStreamObserver(CountDownLatch finishLatch, OperandBroker operandBroker) {
        super(finishLatch);
