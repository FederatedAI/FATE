...
@Component
@Scope("prototype")
public class SubtractByKeyServiceProcessor extends BaseProcessServiceProcessor<Processor.BinaryProcess, StorageBasic.StorageLocator> {
    public SubtractByKeyServiceProcessor(EggProcessServiceClient eggProcessServiceClient, Processor.BinaryProcess request, BasicMeta.Endpoint processorEndpoint) {
        super(eggProcessServiceClient, request, processorEndpoint);
    }

    @Override
    public StorageBasic.StorageLocator call() throws Exception {
        return eggProcessServiceClient.subtractByKey(request, processorEndpoint);
    }
}
