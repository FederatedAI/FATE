...
@Component
@Scope("prototype")
public class UnionServiceProcessor extends BaseProcessServiceProcessor<Processor.BinaryProcess, StorageBasic.StorageLocator> {
    public UnionServiceProcessor(EggProcessServiceClient eggProcessServiceClient, Processor.BinaryProcess request, BasicMeta.Endpoint processorEndpoint) {
        super(eggProcessServiceClient, request, processorEndpoint);
    }

    @Override
    public StorageBasic.StorageLocator call() throws Exception {
        return eggProcessServiceClient.union(request, processorEndpoint);
    }
}
