...
from eggroll.api.proto import basic_meta_pb2, federation_pb2, federation_pb2_grpc, storage_basic_pb2
...
class FederationRuntime(object):
    ...
    def remote(self, obj, name: str, tag: str, role=None, idx=-1):
        ...
        src = federation_pb2.Party(partyId="{}".format(self.party_id), name=self.role)
