...
class KVServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.createIfAbsent = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/createIfAbsent',
    ...
    self.put = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/put',
    ...
    self.putIfAbsent = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/putIfAbsent',
        request_serializer=kv__pb2.Operand.SerializeToString,
        response_deserializer=kv__pb2.Operand.FromString,
        )
    self.putAll = channel.stream_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/putAll',
        request_serializer=kv__pb2.Operand.SerializeToString,
        response_deserializer=kv__pb2.Empty.FromString,
        )
    self.delOne = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/delOne',
        request_serializer=kv__pb2.Operand.SerializeToString,
        response_deserializer=kv__pb2.Operand.FromString,
        )
    self.get = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/get',
        request_serializer=kv__pb2.Operand.SerializeToString,
        response_deserializer=kv__pb2.Operand.FromString,
        )
    self.iterate = channel.unary_stream(
        '/com.webank.ai.eggroll.api.storage.KVService/iterate',
        request_serializer=kv__pb2.Range.SerializeToString,
        response_deserializer=kv__pb2.Operand.FromString,
        )
    self.destroy = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/destroy',
        request_serializer=kv__pb2.Empty.SerializeToString,
        response_deserializer=kv__pb2.Empty.FromString,
        )
    self.destroyAll = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/destroyAll',
        request_serializer=kv__pb2.Empty.SerializeToString,
        response_deserializer=kv__pb2.Empty.FromString,
        )
    self.count = channel.unary_unary(
        '/com.webank.ai.eggroll.api.storage.KVService/count',
        request_serializer=kv__pb2.Empty.SerializeToString,
...
def add_KVServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'com.webank.ai.eggroll.api.storage.KVService', rpc_method_handlers)
