...
class TransferSubmitServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.send = channel.unary_unary(
        '/com.webank.ai.eggroll.api.driver.federation.TransferSubmitService/send',
    ...
    self.recv = channel.unary_unary(
        '/com.webank.ai.eggroll.api.driver.federation.TransferSubmitService/recv',
        request_serializer=federation__pb2.TransferMeta.SerializeToString,
        response_deserializer=federation__pb2.TransferMeta.FromString,
        )
    self.checkStatusNow = channel.unary_unary(
        '/com.webank.ai.eggroll.api.driver.federation.TransferSubmitService/checkStatusNow',
        request_serializer=federation__pb2.TransferMeta.SerializeToString,
        response_deserializer=federation__pb2.TransferMeta.FromString,
        )
    self.checkStatus = channel.unary_unary(
        '/com.webank.ai.eggroll.api.driver.federation.TransferSubmitService/checkStatus',
        request_serializer=federation__pb2.TransferMeta.SerializeToString,
        response_deserializer=federation__pb2.TransferMeta.FromString,
        )
...
def add_TransferSubmitServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'com.webank.ai.eggroll.api.driver.federation.TransferSubmitService', rpc_method_handlers)
