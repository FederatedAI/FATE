...
import com.webank.ai.eggroll.core.serdes.SerDes;
...
@Component
@Scope("prototype")
public class GeneralJsonBytesSerDes extends BaseSerDes implements SerDes {

    private static final MapType defaultHashMapType
            = TypeFactory.defaultInstance().constructMapType(HashMap.class, String.class, String.class);
    private static final Logger LOGGER = LogManager.getLogger(GeneralJsonBytesSerDes.class);
    private final ObjectMapper objectMapper;
    private final ObjectWriter defaultWriter;
    private final ObjectWriter prettyWriter;
    private final ObjectMapper stringMapper;

    public GeneralJsonBytesSerDes() {
    ...
    public byte[] serialize(Object object) {
        ...
        try {
            return defaultWriter.writeValueAsBytes(object);
        } catch (JsonProcessingException e) {
            throw new RuntimeException("Failed to serialize object to json byte array", e);
        }
    }
    ...
    public <T> T deserialize(Serializable serializable, Class<T> clazz) {
        ...
        super.checkParamType(byte[].class, serializable.getClass());

        try {
            return objectMapper.readValue((byte[]) serializable, clazz);
        } catch (IOException e) {
