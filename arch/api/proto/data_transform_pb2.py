...
_SCALEOBJECT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='scale', full_name='com.webank.ai.fate.core.mlmodel.buffer.ScaleObject.scale', index=5,
