...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='',
  syntax='proto3',
  serialized_pb=_b('\n\x12\x64\x61ta-io-meta.proto\"\x9a\x01\n\nDataIOMeta\x12\x14\n\x0cinput_format\x18\x01 \x01(\t\x12\x11\n\tdelimitor\x18\x02 \x01(\t\x12\x11\n\tdata_type\x18\x03 \x01(\t\x12\x12\n\nwith_label\x18\x04 \x01(\x08\x12\x11\n\tlabel_idx\x18\x05 \x01(\x05\x12\x12\n\nlabel_type\x18\x06 \x01(\t\x12\x15\n\routput_format\x18\x07 \x01(\tb\x06proto3')
)
...
_DATAIOMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='with_label', full_name='DataIOMeta.with_label', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_idx', full_name='DataIOMeta.label_idx', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='label_type', full_name='DataIOMeta.label_type', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output_format', full_name='DataIOMeta.output_format', index=6,
