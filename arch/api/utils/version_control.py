...
def get_version_table(data_table_namespace):
    version_table = table_manager.table(name=data_table_namespace, namespace="version_control",
...
def get_commit_tmp_table(data_table_namespace):
    version_tmp_table = table_manager.table(name=data_table_namespace, namespace="version_tmp",
                                      partition=1, create_if_missing=True, error_if_exist=False)
