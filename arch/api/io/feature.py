...
#
from arch.api.io.version_control import version_for_read, version_for_save, gen_data_table_info, get_data_table, save_version_info
...
def save_feature_header(features, labels, commit_log="", commit_id=None,  tag=None, branch="master"):
    version_table, data_table_info, scene_key, parent, commit_id = version_for_save("feature_header_version",
                                                                                    commit_id=commit_id,
                                                                                    tag=tag,
                                                                                    branch=branch)
...
def read_feature_header(commit_id=None, tag=None, branch="master"):
    version_table, data_table_info, scene_key, parent, commit_id = version_for_read("feature_header_version",
                                                                                    commit_id=commit_id,
                                                                                    tag=tag,
                                                                                    branch=branch)
    if commit_id:
...
def save_feature_meta(kv_meta, commit_log="", commit_id=None, tag="", branch="master"):
    version_table, data_table_info, scene_key, parent, commit_id = version_for_save("feature_version",
                                                                                    commit_id=commit_id,
                                                                                    tag=tag,
                                                                                    branch=branch)
...
def read_feature_meta(commit_id=None, tag=None, branch="master"):
    version_table, data_table_info, scene_key, parent, commit_id = version_for_read("feature_version",
                                                                                    commit_id=commit_id,
                                                                                    tag=tag,
                                                                                    branch=branch)
    feature_meta = dict()
