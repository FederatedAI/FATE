...
from federatedrec.neural_cf.hetero_ncf.hetero_ncf_base import HeteroNCFBase
from federatedrec.neural_cf.hetero_ncf.backend import NCFModel
from federatedrec.neural_cf.hetero_ncf.ncf_data_convertor import NCFDataConverter

LOGGER = log_utils.getLogger()


class HeteroNCFClient(HeteroNCFBase):
    def __init__(self):
        super(HeteroNCFClient, self).__init__()
    ...
    def _init_model(self, param):
        ...
        self.data_converter = NCFDataConverter()
    ...
    def fit(self, data_instances, validate_data=None):
        ...
        self._model = NCFModel.build_model(user_num=self.user_num, item_num=item_num,
    ...
    def _get_meta(self):
        ...
        meta_pb = ncf_model_meta_pb2.NCFModelMeta()
    ...
    def _get_param(self):
        ...
        :return:
        """
        from federatedml.protobuf.generated import ncf_model_param_pb2
        LOGGER.info(f"_get_param")
        param_pb = ncf_model_param_pb2.NCFModelParam()
    ...
    def predict(self, data_inst):
        ...
        if self.flowid == 'validate':
            # use NCFSequenceData in evaluation procedure (after training procedure)
            ...
            # use NCFSequencePredictData in prediction procedure
    ...
    def load_model(self, model_dict):
        ...
        self._model = NCFModel.restore_model(model_obj.saved_model_bytes, model_obj.user_num, model_obj.item_num, self.model_param.init_param.embed_dim)
        self._model.set_user_num(model_obj.user_num)
        self._model.set_item_num(model_obj.item_num)


class HeteroNCFHost(HeteroNCFClient):
    """
    Host HeteroNCF Class, implement the get_user_num and send_user_num function
    """
...
class HeteroNCFGuest(HeteroNCFClient):
    """
    Guest HeteroNCF Class, implement the get_user_num and send_user_num function
    """
