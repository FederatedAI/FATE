...
class HeteroGMFTransferVariable(BaseTransferVariables):
    def __init__(self, flowid=0):
        ...
        self.guest_user_num = self._create_variable(name='guest_user_num', src=['guest'], dst=['host'])
        ...
        self.host_user_num = self._create_variable(name='host_user_num', src=['host'], dst=['guest'])
