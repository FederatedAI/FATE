...
cd /data/projects/
wget https://webank-ai-1251170195.cos.ap-guangzhou.myqcloud.com/ansible_nfate_1.5.3_release-1.0.0.tar.gz
tar xzf ansible_nfate_1.5.3_release-1.0.0.tar.gz
```
