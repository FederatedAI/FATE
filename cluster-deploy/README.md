...
```
packages
├── eggroll-api-1.3.1.tar.gz
├── eggroll-computing-1.3.1.tar.gz
├── eggroll-conf-1.3.1.tar.gz
├── eggroll-egg-1.3.1.tar.gz
├── eggroll-meta-service-1.3.1.tar.gz
├── eggroll-roll-1.3.1.tar.gz
├── eggroll-storage-service-cxx-1.3.1.tar.gz
├── fateboard-1.3.1.jar
├── fate-federation-1.3.1.tar.gz
├── fate-proxy-1.3.1.tar.gz
├── __init__.py
├── jdk-8u192-linux-x64.tar.gz
├── Miniconda3-4.5.4-Linux-x86_64.sh
├── mysql-8.0.13-linux-glibc2.12-x86_64.tar.xz
├── pip-packages-fate-1.3.1.tar.gz
├── redis-5.0.2.tar.gz
