...
cd /data/projects/
wget https://webank-ai-1251170195.cos.ap-guangzhou.myqcloud.com/ansible_nfate_1.4.3_release_1.0.5.tar.gz
tar xzf ansible_nfate_1.4.3_release_1.0.5.tar.gz
```
