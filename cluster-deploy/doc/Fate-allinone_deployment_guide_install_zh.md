...
```
cd /data/projects/
wget https://webank-ai-1251170195.cos.ap-guangzhou.myqcloud.com/fate_cluster_install_1.5.1_preview-c7-u18.tar.gz
tar xzf fate_cluster_install_1.5.1_preview-c7-u18.tar.gz
```
