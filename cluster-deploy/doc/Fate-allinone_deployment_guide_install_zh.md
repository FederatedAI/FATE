...
node_list=(1.2.0.168.0.1 1.2.0.168.0.2)
...
Fateboard是一项Web服务。如果成功启动了fateboard服务，则可以通过访问 http://1.2.0.168.0.1:8080 和 http://1.2.0.168.0.2:8080 来查看任务信息，如果有防火墙需开通。
