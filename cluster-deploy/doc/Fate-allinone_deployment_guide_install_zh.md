...
```
cd /data/projects/
wget https://webank-ai-1251170195.cos.ap-guangzhou.myqcloud.com/fate-cluster-install-1.4.6-release-c7-u18.tar.gz
tar xzf fate-cluster-install-1.4.6-release-c7-u18.tar.gz
```
