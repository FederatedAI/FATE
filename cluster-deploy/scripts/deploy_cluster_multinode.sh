...
packaging_fate_flow() {
    ...
    sed -i.bak "s#jar_version=.*#jar_version=${fateflow_jar_version}#g" ./configurations.sh.tmp
    sed -i.bak "s#source_code_dir=.*#source_code_dir=${source_code_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#output_packages_dir=.*#output_packages_dir=${output_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#deploy_packages_dir=.*#deploy_packages_dir=${deploy_packages_dir}#g" ./configurations.sh.tmp
...
packaging_fateboard() {
    cp configurations.sh configurations.sh.tmp
    sed -i.bak "s#version=.*#version=${version}#g" ./configurations.sh.tmp
    sed -i.bak "s#jar_version=.*#jar_version=${fateboard_jar_version}#g" ./configurations.sh.tmp
    sed -i.bak "s#source_code_dir=.*#source_code_dir=${source_code_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#output_packages_dir=.*#output_packages_dir=${output_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#deploy_packages_dir=.*#deploy_packages_dir=${deploy_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s/db_user=.*/db_user=${db_auth[0]}/g" ./configurations.sh.tmp
...
packaging_federation() {
    cp configurations.sh configurations.sh.tmp
    sed -i.bak "s#version=.*#version=${version}#g" ./configurations.sh.tmp
    sed -i.bak "s#jar_version=.*#jar_version=${federation_jar_version}#g" ./configurations.sh.tmp
    sed -i.bak "s#source_code_dir=.*#source_code_dir=${source_code_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#output_packages_dir=.*#output_packages_dir=${output_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#deploy_packages_dir=.*#deploy_packages_dir=${deploy_packages_dir}#g" ./configurations.sh.tmp
    sh ./deploy.sh ${deploy_mode} packaging ./configurations.sh.tmp
...
packaging_proxy() {
    cp configurations.sh configurations.sh.tmp
    sed -i.bak "s#version=.*#version=${version}#g" ./configurations.sh.tmp
    sed -i.bak "s#jar_version=.*#jar_version=${proxy_jar_version}#g" ./configurations.sh.tmp
    sed -i.bak "s#source_code_dir=.*#source_code_dir=${source_code_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#output_packages_dir=.*#output_packages_dir=${output_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#deploy_packages_dir=.*#deploy_packages_dir=${deploy_packages_dir}#g" ./configurations.sh.tmp
    sh ./deploy.sh ${deploy_mode} packaging ./configurations.sh.tmp
...
packaging_roll() {
    cp configurations.sh configurations.sh.tmp
    sed -i.bak "s#version=.*#version=${version}#g" ./configurations.sh.tmp
    sed -i.bak "s#jar_version=.*#jar_version=${roll_jar_version}#g" ./configurations.sh.tmp
    sed -i.bak "s#source_code_dir=.*#source_code_dir=${source_code_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#output_packages_dir=.*#output_packages_dir=${output_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#deploy_packages_dir=.*#deploy_packages_dir=${deploy_packages_dir}#g" ./configurations.sh.tmp
    sh ./deploy.sh ${deploy_mode} packaging ./configurations.sh.tmp
...
packaging_metaservice() {
    cp configurations.sh configurations.sh.tmp
    sed -i.bak "s#version=.*#version=${version}#g" ./configurations.sh.tmp
    sed -i.bak "s#jar_version=.*#jar_version=${meta_service_jar_version}#g" ./configurations.sh.tmp
    sed -i.bak "s#source_code_dir=.*#source_code_dir=${source_code_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#output_packages_dir=.*#output_packages_dir=${output_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#deploy_packages_dir=.*#deploy_packages_dir=${deploy_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s/db_user=.*/db_user=${db_auth[0]}/g" ./configurations.sh.tmp
...
packaging_egg() {
    cp configurations.sh configurations.sh.tmp
    sed -i.bak "s#version=.*#version=${version}#g" ./configurations.sh.tmp
    sed -i.bak "s#jar_version=.*#jar_version=${egg_jar_version}#g" ./configurations.sh.tmp
    sed -i.bak "s#source_code_dir=.*#source_code_dir=${source_code_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#output_packages_dir=.*#output_packages_dir=${output_packages_dir}#g" ./configurations.sh.tmp
    sed -i.bak "s#deploy_packages_dir=.*#deploy_packages_dir=${deploy_packages_dir}#g" ./configurations.sh.tmp
    sh ./deploy.sh ${deploy_mode} packaging ./configurations.sh.tmp
