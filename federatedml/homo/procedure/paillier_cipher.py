...
class Host(paillier_keygen_sync.Host, paillier_re_cipher_sync.Host):
    ...
    def register_paillier_cipher(self, transfer_variables):
        self.register_paillier_keygen(use_encrypt_transfer=transfer_variables.use_encrypt,
                                      pubkey_transfer=transfer_variables.paillier_pubkey)
        self.register_paillier_re_cipher(re_encrypt_times_transfer=transfer_variables.re_encrypt_times,
