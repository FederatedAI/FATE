...
class HeteroKmeansTransferVariable(BaseTransferVariables):
    def __init__(self, flowid=0):
        ...
        self.guest_tol = self._create_variable(name='guest_tol')
        self.host_dist = self._create_variable(name='host_dist')
        self.host_tol = self._create_variable(name='host_tol')
