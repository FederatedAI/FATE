...
class AIFELTransferVariable(BaseTransferVariables):
    def __init__(self, flowid=0):
        ...
        self.guest_size = self._create_variable(name='guest_size')
        ...
        self.host_size = self._create_variable(name='host_size')
