...
class HomoLRTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        ...
        self.model_to_re_encrypt = Variable(name='HomoLRTransferVariable.model_to_re_encrypt', auth=dict(src='host', dst=['arbiter']), transfer_variable=self)
        self.model_re_encrypted = Variable(name='HomoLRTransferVariable.model_re_encrypted', auth=dict(src='arbiter', dst=['host']), transfer_variable=self)
