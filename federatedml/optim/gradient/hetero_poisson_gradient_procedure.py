...
from federatedml.optim.gradient import hetero_poisson_gradient_sync

LOGGER = log_utils.getLogger()


class Guest(hetero_poisson_gradient_sync.Guest):
...
class Host(hetero_poisson_gradient_sync.Host):
    def register_gradient_procedure(self, transfer_variables):
        self._register_gradient_sync(transfer_variables.host_forward,
                                     transfer_variables.fore_gradient,
...
class Arbiter(hetero_poisson_gradient_sync.Arbiter):
    def register_gradient_procedure(self, transfer_variables):
