...
FATE has provided a novel lossless privacy-preserving tree-boosting system known as `[SecureBoost: A Lossless Federated Learning Framework]. <https://arxiv.org/abs/1901.08755>`_
...
Applications
^^^^^^^^^^^^
The fast sbt supports the following applications.
