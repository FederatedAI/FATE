...
if __name__ == "__main__":
    jobid = "test_hetero_sample_" + str(int(time.time() * 1000))

    host_job = threading.Thread(target=run_hetero_sampler_host_test, args=[jobid])
    
    guest_job = threading.Thread(target=run_hetero_sampler_guest_test, args=[jobid])
