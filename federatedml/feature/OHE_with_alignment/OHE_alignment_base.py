...
class OHEAlignmentBase(OneHotEncoder):
    ...
    def fit(self, data_instances):
        ...
        if self.need_alignment:
            ...
            LOGGER.debug("new transform col names after format received aligned columns: {}".format(transform_col_names))        
        ...
        LOGGER.debug("[Result][OHEAlignment{}] After transform in fit, schema is : {}, header: {}".format(self.role, self.schema,
                                                                                self.inner_param.header))
