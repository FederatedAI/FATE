...
from federatedml.frameworks.homo.coordinate.transfer import host2arbiter, arbiter2host
...
class GenPaillierCipher(Coordinate):
    ...
    def arbiter_call(self, encrypt_param):
        ...
        for idx, use_encryption in enumerate(hosts_use_encryption):
            if not use_encryption:
                ...
                cipher.generate_key(encrypt_param.key_length)
