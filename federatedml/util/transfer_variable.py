...
class RawIntersectTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        self.intersect_host_ids = Variable(name="RawIntersectTransferVariable.intersect_host_ids", auth={'src': "host", 'dst': ['guest']})
        self.intersect_ids = Variable(name="RawIntersectTransferVariable.intersect_ids", auth={'src': "guest", 'dst': ['host']})
        pass
