...
class BaseTransferVariable(object):
    ...
    def generate_transferid(self, transfer_var, *suffix):
        ...
        transferid = '.'.join([transfer_var.name, str(self.taskid), str(self.flowid)])
        if suffix:
...
class HeteroFeatureSelectionTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        self.result_left_cols = Variable(name="HeteroFeatureSelectionTransferVariable.result_left_cols",
                                         auth={'src': "guest", 'dst': ['host']})
        self.host_select_cols = Variable(name="HeteroFeatureSelectionTransferVariable.host_select_cols",
                                         auth={'src': "host", 'dst': ['guest']})
        pass
...
class HeteroCorrelationTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        self.encrypted_data = Variable(name="HeteroCorrelationTransferVariable.encrypted_data",
                                       auth={'src': "guest", 'dst': ['host']})
        self.inner_product = Variable(name="HeteroCorrelationTransferVariable.inner_product",
                                      auth={'src': "host", 'dst': ['guest']})
        pass
...
class SecureAddExampleTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        self.guest_share = Variable(name="SecureAddExampleTransferVariable.guest_share",
                                    auth={'src': "guest", 'dst': ['host']})
        self.host_share = Variable(name="SecureAddExampleTransferVariable.host_share",
                                   auth={'src': "host", 'dst': ['guest']})
        self.host_sum = Variable(name="SecureAddExampleTransferVariable.host_sum",
                                 auth={'src': "host", 'dst': ['guest']})
        pass
...
class OneVsRestTransferVariable(BaseTransferVariable):
    def define_transfer_variable(self):
        self.host_classes = Variable(name="OneVsRestTransferVariable.host_classes",
                                     auth={'src': "host", 'dst': ['guest']})
        self.aggregate_classes = Variable(name="OneVsRestTransferVariable.aggregate_classes",
                                          auth={'src': "guest", 'dst': ['host', 'arbiter']})
        pass
