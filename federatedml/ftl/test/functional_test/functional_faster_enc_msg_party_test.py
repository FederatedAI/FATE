...
if __name__ == '__main__':
    ...
    partyA = FasterEncryptedFTLGuestModel(autoencoder_A, mock_model_param, public_key=publickey)
    partyB = FasterEncryptedFTLHostModel(autoencoder_B, mock_model_param, public_key=publickey)
