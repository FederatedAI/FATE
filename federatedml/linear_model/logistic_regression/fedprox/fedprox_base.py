...
from federatedml.param.fedprox_param import FedProxParam
from federatedml.protobuf.generated import lr_model_meta_pb2
from federatedml.secureprotol import PaillierEncrypt, FakeEncrypt
from federatedml.statistic import data_overview
from federatedml.transfer_variable.transfer_class.AIFEL_transfer_variable import AIFELTransferVariable
...
class FedProxBase(BaseLogisticRegression):
    def __init__(self):
        super(FedProxBase, self).__init__()
        self.model_name = 'FedProx'
        self.model_param_name = 'FedProxParam'
        self.model_meta_name = 'FedProxMeta'
        self.mode = consts.HOMO
        self.model_param = FedProxParam()
        self.aggregator = None

    def _init_model(self, params):
        super(FedProxBase, self)._init_model(params)
    ...
    def _compute_loss(self, data_instances,prev_round_weights):
        ...
        loss_norm = self.optimizer.loss_norm(self.model_weights,self.use_fedprox, prev_round_weights)
        LOGGER.debug("**AIFEL** calculating loss + norm")
