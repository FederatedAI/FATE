...
import numpy as np
from federatedml.linear_model.fm.base_fm import BaseFM
from federatedml.param.fm_param import HeteroFMParam
...
from federatedml.optim.optimizer import optimizer_factory_v,optimizer_factory_w

from arch.api.utils import log_utils
LOGGER = log_utils.getLogger()
class HeteroFMBase(BaseFM):
    def __init__(self):
        super().__init__()
        self.model_name = 'HeteroFM'
        self.model_param_name = 'HeteroFMParam'
        self.model_meta_name = 'HeteroFMMeta'
        ...
        self.model_param = HeteroFMParam()
        self.model_feature_emb = None
    ...
    def _init_model(self, params):
        ...
        self.optimizer_w = optimizer_factory_w(params)
        self.optimizer_v = optimizer_factory_v(params)
        self.K = params.K
    ...
    def cal_ui_dot_sum(self,feature, model_feature_emb):
    ...
    def cal_ui_sum(self,feature, model_feature_emb):
        feature_num = model_feature_emb.shape[0]
        feature_dim = model_feature_emb.shape[1]
