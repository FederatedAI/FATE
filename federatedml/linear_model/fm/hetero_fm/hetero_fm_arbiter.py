...
from federatedml.framework.hetero.procedure import paillier_cipher
...
class HeteroFMArbiter(HeteroBaseArbiter, HeteroFMBase):
    ...
    def fit_binary(self, data_instances, validate_data):
        ...
        """
        LOGGER.info("Enter hetero fm arbiter fit")
        ...
        while self.n_iter_ < self.max_iter:
            ...
            for batch_index in batch_data_generator:
                ...
                if total_gradient is None:
                    total_gradient = gradient[0]
                else:
                    total_gradient = total_gradient + gradient[0]
