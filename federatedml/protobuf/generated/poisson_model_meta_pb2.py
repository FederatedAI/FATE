...
_POISSONMODELMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='early_stop', full_name='com.webank.ai.fate.core.mlmodel.buffer.PoissonModelMeta.early_stop', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fit_intercept', full_name='com.webank.ai.fate.core.mlmodel.buffer.PoissonModelMeta.fit_intercept', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exposure_colname', full_name='com.webank.ai.fate.core.mlmodel.buffer.PoissonModelMeta.exposure_colname', index=10,
