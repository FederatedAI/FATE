...
_POISSONMODELMETA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='exposure_index', full_name='com.webank.ai.fate.core.mlmodel.buffer.PoissonModelMeta.exposure_index', index=11,
