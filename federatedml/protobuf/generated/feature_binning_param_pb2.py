...
_BINNINGONEPARTYRESULT = _descriptor.Descriptor(
  name='BinningOnePartyResult',
  full_name='com.webank.ai.fate.core.mlmodel.buffer.BinningOnePartyResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='com.webank.ai.fate.core.mlmodel.buffer.BinningOnePartyResult.results', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATUREBINNINGPARAM_HOSTVALUESENTRY = _descriptor.Descriptor(
  name='HostValuesEntry',
  full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.HostValuesEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.HostValuesEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.HostValuesEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATUREBINNINGPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='self_values', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.self_values', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='host_values', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.host_values', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='model_name', full_name='com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.model_name', index=5,
  ...
  nested_types=[_FEATUREBINNINGPARAM_HOSTVALUESENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_BINNINGONEPARTYRESULT.fields_by_name['results'].message_type = _BINNINGSINGLEFEATUREVALUE
_FEATUREBINNINGPARAM_HOSTVALUESENTRY.fields_by_name['value'].message_type = _BINNINGONEPARTYRESULT
_FEATUREBINNINGPARAM_HOSTVALUESENTRY.containing_type = _FEATUREBINNINGPARAM
...
_FEATUREBINNINGPARAM.fields_by_name['self_values'].message_type = _BINNINGONEPARTYRESULT
_FEATUREBINNINGPARAM.fields_by_name['host_values'].message_type = _FEATUREBINNINGPARAM_HOSTVALUESENTRY
...
DESCRIPTOR.message_types_by_name['BinningOnePartyResult'] = _BINNINGONEPARTYRESULT
...
BinningOnePartyResult = _reflection.GeneratedProtocolMessageType('BinningOnePartyResult', (_message.Message,), {
  'DESCRIPTOR' : _BINNINGONEPARTYRESULT,
  '__module__' : 'feature_binning_param_pb2'
  # @@protoc_insertion_point(class_scope:com.webank.ai.fate.core.mlmodel.buffer.BinningOnePartyResult)
  })
_sym_db.RegisterMessage(BinningOnePartyResult)
...
FeatureBinningParam = _reflection.GeneratedProtocolMessageType('FeatureBinningParam', (_message.Message,), {
  ...
  'HostValuesEntry' : _reflection.GeneratedProtocolMessageType('HostValuesEntry', (_message.Message,), {
    'DESCRIPTOR' : _FEATUREBINNINGPARAM_HOSTVALUESENTRY,
    '__module__' : 'feature_binning_param_pb2'
    # @@protoc_insertion_point(class_scope:com.webank.ai.fate.core.mlmodel.buffer.FeatureBinningParam.HostValuesEntry)
    })
  ,
...
_sym_db.RegisterMessage(FeatureBinningParam.HostValuesEntry)


DESCRIPTOR._options = None
_FEATUREBINNINGRESULT_BINNINGRESULTENTRY._options = None
_FEATUREBINNINGPARAM_HOSTVALUESENTRY._options = None
