...
### Cluster Deployment
For deployment, please refer to [FATE ON Spark Deployment Guide](fate_on_spark_deployment_guide.md), where the RabbitMQ section can be skipped and replaced by the Pulsar cluster deployment, see [Pulsar Cluster Deployment](common/pulsar_deployment_guide.md).
